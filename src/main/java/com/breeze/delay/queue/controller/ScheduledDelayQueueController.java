...
@Api(tags = "定时任务实现的延时队列")
public class ScheduledDelayQueueController {

    @Autowired
    private ScheduledDelayQueueService delayQueueService;
    ...
    public BaseResponse saveOrder(
        ...
        int count = this.delayQueueService.saveOrder(order);
